<template>
  ...
  >
    ...
    >
      ...
      <a
        :href="`${windowRef.baseUrl}/project/issues?directories=${bloc.path}&id=${projectKey}&resolved=false`"
        target="_blank"
...
import IconNotCovered from 'Icons/icon-not-covered.svg';
import IconCheck from 'Icons/icon-check-solid.svg';
import IconCopyLink from 'Icons/icon-copy-link.svg';
