...
module.exports = {
  meta: {
    ...
    messages: {
      updatedUnused: "var '{{ varName }}' is updated but never used",
    },
    ...
    return {
      UpdateExpression(node) {
        ...
        unusedVars.forEach((unusedVar) => {
          unusedVar.references.forEach((reference) => {
            if (reference.identifier.loc === node.argument.loc) {
              context.report({
                node,
                messageId: 'updatedUnused',
                data: {
